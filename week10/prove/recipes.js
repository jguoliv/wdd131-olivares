const recipes = [
	{
		...
		recipeIngredient: [
			...
			'3/4 C milk','1 Tbsp Brown Sugar','2 tsp Shredded Ginger','3/4 C Mashed Sweet Potatoes',
			'1 Tbsp Minced Shallots','1 Tbsp Baking Powder','1 Tbsp Chives','1/4 C Cornmeal','1 C Flour'
		],
	...
	},
	{
		...
		tags: ['Dessert', 'German'],
		description: "This gooseberry cake with crumble is easy to follow, a bit tart and not too sweet. Made up of a cake base, filled with fresh gooseberries and vanilla cream and finished off with crumble. A must have recipe for gooseberry lovers!!",
		image: './images/german-gooseberry-cake.jpg',
		recipeIngredient: [
			'For the Cake Base:',
			'180 g plain flour','2 medium eggs','100 g butter soft',
			'2 teaspoons vanilla sugar','60 g sugar','2 ½ teaspoons baking powder',
			'For the Vanilla Cream:',
			'250 ml milk','40 g corn flour (cornstarch)','2 tablespoons sugar',
			'1 tablespoon vanilla sugar','200 g sour cream',
			'For the Streusel (crumble):',
			'250 g plain flour','2 tablespoons vanilla sugar','175 g butter soft','100 g sugar',
			'You will also need:',
			'550 g gooseberries washed and stems removed OR 550 g raspberries'
		],
		name: 'Gooseberry Cake with Vanilla Cream and Crumble',
		prepTime: '30 min',
		recipeInstructions: [
			'Combine the flour, butter, sugar and eggs in a bowl and beat with a whisk until you have a smooth dough. Transfer to a lined 26 cm spring-form. Smooth with a spoon and set aside.',
			"In the same bowl combine sugar, butter and flour for the crumble. Mix with your hands until small crumbles form. Set aside. Preheat oven to 180°C (356°F).",
			'In a small pot combine milk, sugar and cornstarch. Stir constantly until thickened. Let cool 2-3 minutes. Scatter gooseberries over the base. Whisk in sour cream then spread vanilla cream over gooseberries. Sprinkle crumble on top and bake 45 minutes until golden. Cool and serve with whipped cream.'
		],
	...
	},
	{
		...
		recipeInstructions: [
			...
			'Place sliced apples in a 9x13-inch baking dish. Mix white sugar, 1 tablespoon flour, and cinnamon; sprinkle over apples. Pour water evenly over apples.',
			'Combine oats, 1 cup flour, brown sugar, baking powder, and baking soda. Add melted butter and mix with a fork until crumbly; sprinkle over apple mixture.',
			'Bake until top is golden brown and apples are bubbling, about 45 minutes.'
		],
		recipeYield: '12 servings',
		rating: 4
	}
